...
;;  2. inserting ROAM_REFS via the 'citar' UI
;;
;;  The latter is dependent, however, on:
;;
...
(defun citar-org-roam-setup ()
  ...
  (add-to-list 'citar-open-note-functions 'citar-org-roam--open-note)
...
(defun citar-org-roam-reset ()
  ...
  (delete 'citar-org-roam--open-note-function 'citar-open-note-functions)
  (delete 'citar-org-roam--keys-with-notes 'citar-keys-with-note-functions))
